...
2. Decide mode from user intent:
   - If the user asks to inspect, preview, review, or has not clearly asked to write, run ingest in dry-run mode.
...
- If the run was dry-run only, suggest re-running `/kb:ingest` with explicit write intent.
